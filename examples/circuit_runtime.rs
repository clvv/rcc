fn main() {
    let compute = || {
        ...
        let add_2 = |wires_add: &[usize], in_add_0, in_add_1| {
            (*wire(wires_add[0usize])) = (*wire(in_add_0)) + (*wire(in_add_1));
        };
        let sub_3 = |wires_sub: &[usize], in_sub_0, in_sub_1| {
            (*wire(wires_sub[0usize])) = (*wire(in_sub_0)) - (*wire(in_sub_1));
        };
        let gen_1 = |wires_gen: &[usize], in_gen_0| {
            add_2(
                wires_gen[1usize..2usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[0usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[4usize..5usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[3usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[7usize..8usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[6usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[10usize..11usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[9usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[13usize..14usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[12usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[16usize..17usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[15usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[19usize..20usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[18usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[22usize..23usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[21usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[25usize..26usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[24usize],
            );
            sub_3(
            ...
            add_2(
                wires_gen[28usize..29usize].try_into().unwrap(),
                in_gen_0,
                wires_gen[27usize],
            );
            sub_3(
