...
mod halo2_collatz_runtime_lib;
use halo2_collatz_runtime_lib::generate_witnesses;
...
fn main() {
    ...
    let plaf_string =
        std::fs::read_to_string("circuit-examples/examples/halo2_collatz_config.toml")
