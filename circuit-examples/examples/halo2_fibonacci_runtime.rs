...
mod halo2_fibonacci_runtime_lib;
use halo2_fibonacci_runtime_lib::generate_witnesses;
...
fn main() {
    ...
    let plaf_string =
        std::fs::read_to_string("circuit-examples/examples/halo2_fibonacci_config.toml")
